    ...
    return (
        <div className="w-full flex justify-center flex-col items-center h-[75vh]">
            <div className="w-1/2 flex justify-center flex-col items-center p-4">
                ...
                <a href='/#' className='underline underline-offset-2 mt-4 text-sm'>Forgot password?</a>
                <p className="text-sm mt-4">Don't have an account? <a href='/#' className='underline underline-offset-2 mt-4 text-sm'>Create new account</a></p>
            </div>
            </div>
        </div>
    )
