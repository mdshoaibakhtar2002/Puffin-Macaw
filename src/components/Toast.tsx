...
export default function Toast() {
    return (
        <div id="toast-default" className="absolute right-10 z-10 flex items-center w-full max-w-xs p-4 text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800" role="alert">
